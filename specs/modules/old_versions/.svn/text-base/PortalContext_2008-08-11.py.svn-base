...
# Version: 2008-08-08
# Revision history: 'moved layout and added 'page_name' to context_processors.py
    ...
    for cell in cells:
        ...
        for e in entry_set[key]: 
            ...
            if user_clearance:        
                ...
                #entry_list_name.append({'menu_1_items': '123'})
                menu = menus.pikry_luottamukselliset(request)
                entry_list_name.append(menu)
