...
function picasaweb(j){ //returns the list of all albums for the user
 $("<div style='margin-left:3px'>Kaikki kuvagalleriat</div><!--<div style='text-align:right; margin-right:5px; margin-top:-14px'><a target=PICASA class='standard' href='http://picasaweb.google.com/"+username+"/'>View this gallery in Picasa</a></div>--><br>");
 $("<table border=0><tr>");
...
function albums(j){  //returns all photos in a specific album
 ...
 $("<div style='margin-left:3px'><a class='standard' href='" + window.location.protocol + "//" + window.location.hostname+window.location.pathname+"'>Kaikki kuvagalleriat</a> &gt; "+ j.feed.title.$t +"&nbsp;&nbsp;["+np+" kuva"+item_plural+"]</div><!--<div style='text-align:right; margin-right:5px; margin-top:-14px'><a target=PICASA class='standard' href='"+album_link+"'>View this album in Picasa</a></div>--><br>");
 $("<table border=0><tr>");
...
$("<div style='margin-left:3px'><a class='standard' href='"+ window.location.protocol + "//" + window.location.hostname+window.location.pathname+"'>Kaikki kuvagalleriat</a> &gt; <a class='standard' href='" + album_base_path + "'>" + my_fixed_galleryname + "</a> &gt; <!--" + img_filename + "-->" + current_index_text + "</div><!--<div style='text-align:right; margin-right:3px; margin-top:-14px'><a target=PICASA class='standard' href='"+photo_link+"'>View this image in Picasa</a></div>--><br>");
...
if (n1 == null) //we're at the last picture in the album; going forward takes us to the album index
 ...
 if (photo_array.length > 1) { $("<td><a class='standard' href='"+prev+"'><img border=0 alt='Edellinen kuva' src='/img/arrows/naviarr_or_prev.gif'></a> </td><td></td>"); }
 $("<td> <a class='standard' href='"+album_base_path+"'><img border=0 alt='T&auml;m&auml;n kuvagallerian p&auml;&auml;sivu' src='/img/arrows/naviarr_or_beg.gif'></a> </td>");
 if (photo_array.length > 1) { $("<td></td><td> <a class='standard' href='"+next+"'><img border=0 alt='Seuraava kuva' src='/img/arrows/naviarr_or_next.gif'></a></td>"); }
 $("</tr></table></center><br>");
