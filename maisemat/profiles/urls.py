...
from maisemat.profile.forms import ProfileForm

urlpatterns = patterns('',
    url(r'^create/$', views.create_profile, {'form_class': ProfileForm}, name='profiles_create_profile'),
    url(r'^edit/$', views.edit_profile, {'form_class': ProfileForm}, name='profiles_edit_profile'),
