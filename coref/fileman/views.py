...
from coref.fileman.settings import *
# import models
from coref.fileman.models import Setting, Alias
from django.contrib.auth.models import User
# import utils
from coref.fileman.forms import UploadForm
from coref.fileman.utils import File, createHistory, toUnicode, toString
...
def listBuffer(request):
    if request.user.fileman_Setting.buffer != "":
        buffer = pickle.loads(request.user.fileman_Setting.buffer.encode("utf-8"))
    else:
        buffer = []
    return buffer
